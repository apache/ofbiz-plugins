...
under the License.
-->
<!-- TODO Migrate it to form.xml -->
<#assign termTypes = delegator.findByAnd("TermType",{'parentTypeId':'FINANCIAL_TERM'})>
<#assign uomIds = delegator.findByAnd("Uom",{'uomTypeId':'TIME_FREQ_MEASURE'})>
<div>
      ...
      <td>
        <table class="basic-table" cellspacing="0">
              ...
              <tr>
                ...
                <td>
                    ...
                    <form name="update_${billingAccountTerm.billingAccountTermId}" id="update_${billingAccountTerm.billingAccountTermId}"
                          method="post" action="<@ofbizUrl>updateBillingAccountTermJson</@ofbizUrl>" >
                         ...
                         <a class="buttontext" href="javascript:ajaxSubmitFormUpdateAreas('update_${billingAccountTerm.billingAccountTermId}', '${parameters.editAreaDivId},editPartyBillingAccountPt,partyId=${parameters.partyId}&amp;billingAccountId=${parameters.billingAccountId}&amp;editAreaDivId=${parameters.editAreaDivId}&amp;portalPageId=${parameters.portalPageId}&amp;portalPortletId=${parameters.portalPortletId}&amp;portletSeqId=${parameters.portletSeqId}&amp;areaId=${parameters.areaId}&amp;idDescription=${parameters.idDescription?if_exists}');">${uiLabelMap.CommonUpdate}</a>
                         <a class="buttontext" href="javascript:refrshPortlet('editPartyBillingAccountPt', '${parameters.editAreaDivId}','partyId=${parameters.partyId}&amp;billingAccountId=${parameters.billingAccountId}&amp;editAreaDivId=${parameters.editAreaDivId}&amp;portalPageId=${parameters.portalPageId}&amp;portalPortletId=${parameters.portalPortletId}&amp;portletSeqId=${parameters.portletSeqId}&amp;areaId=${parameters.areaId}&amp;idDescription=${parameters.idDescription?if_exists}','ListPartyPayment','','false','','false');">${uiLabelMap.CommonCancel}</a>
                    </form>
                </td>
                <#else>
                <td>
                ...
                <td>
                    <a href="javascript:refrshPortlet('editPartyBillingAccountPt', '${parameters.editAreaDivId}','partyId=${parameters.partyId}&amp;billingAccountId=${parameters.billingAccountId}&amp;billingAccountTermId=${billingAccountTerm.billingAccountTermId}&amp;editAreaDivId=${parameters.editAreaDivId}&amp;portalPageId=${parameters.portalPageId}&amp;portalPortletId=${parameters.portalPortletId}&amp;portletSeqId=${parameters.portletSeqId}&amp;areaId=${parameters.areaId}&amp;idDescription=${parameters.idDescription?if_exists}','ListPartyPayment','','false','','false');"><img title="${uiLabelMap.IconsTooltips_Edit}" alt="" src="${iconsPurpose.Edit}"></a>
                </td>
                </#if>
                <td>
                    <form name="remove_${billingAccountTerm.billingAccountTermId}" id="remove_${billingAccountTerm.billingAccountTermId}"
                          method="post" action="<@ofbizUrl>removeBillingAccountTermJson</@ofbizUrl>" >
                         <input type="hidden" name="billingAccountTermId" value="${billingAccountTerm.billingAccountTermId}" />
                         <a href="javascript:ajaxSubmitFormUpdateAreas('remove_${billingAccountTerm.billingAccountTermId}', '${parameters.editAreaDivId},editPartyBillingAccountPt,partyId=${parameters.partyId}&amp;billingAccountId=${parameters.billingAccountId}&amp;editAreaDivId=${parameters.editAreaDivId}&amp;portalPageId=${parameters.portalPageId}&amp;portalPortletId=${parameters.portalPortletId}&amp;portletSeqId=${parameters.portletSeqId}&amp;areaId=${parameters.areaId}&amp;idDescription=${parameters.idDescription?if_exists}');" onclick="return confirm('${uiLabelMap.CommonConfirmDelete}')"><img title="${uiLabelMap.IconsTooltips_Delete}" alt="" src="${iconsPurpose.Delete}"></a>
                    </form>
                </td>
              </tr>
            </#list>
          ...
          <tr>
            ...
            <form method="post" action="<@ofbizUrl>createBillingAccountTermJson</@ofbizUrl>" name="newtermform" id="newtermform">
              <table class="basic-table" cellspacing="0">  
              <input type="hidden" name="billingAccountId" value="${parameters.billingAccountId}" />
              <td>
                  <a href="javascript:ajaxSubmitFormUpdateAreas('newtermform', '${parameters.editAreaDivId},editPartyBillingAccountPt,partyId=${parameters.partyId}&amp;billingAccountId=${parameters.billingAccountId}&amp;editAreaDivId=${parameters.editAreaDivId}&amp;portalPageId=${parameters.portalPageId}&amp;portalPortletId=${parameters.portalPortletId}&amp;portletSeqId=${parameters.portletSeqId}&amp;areaId=${parameters.areaId}&amp;idDescription=${parameters.idDescription?if_exists}');"><img title="${uiLabelMap.IconsTooltips_Add}" alt="" src="/images/icons/famfamfam/add.png"></a>
                  <#if termTypes?has_content>
                  ${uiLabelMap.PartyTermType}
                  <select name="termTypeId" class="required">
                      <option value="">${uiLabelMap.CommonSelectOne}</option>
