...
include::plugins/projectmgr/src/docs/asciidoc/_include/prjm_intro.adoc[leveloffset=+1]
...
include::plugins/projectmgr/src/docs/asciidoc/_include/prjm_project.adoc[leveloffset=+2]
