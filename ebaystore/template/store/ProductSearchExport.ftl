                    ...
                    for (i=0;i<leng;i++) {
                        if (i == 0) {
                            document.getElementById('theme')
                                .options[0] = new Option("${uiLabelMap.CommonPleaseSelect}","_NA_");
                        } else {
                            var optVal = resp[i].TemplateId+":"+resp[i].TemplateImageURL;
                            document.getElementById('theme')
                                .options[i] = new Option(resp[i].TemplateName,optVal);
                            j++;
                        }
                    }
                }
                  ...
                  <#if contentList?has_content>
                    <#list contentList as content>
                      <#if !isProductId?has_content>
                        <li <#if id == 1>class="selected"
                            <#assign isProductId = content.product.productId!><#else>id="tabHeader${id}"</#if>>
                          <a href="javascript:document.getElementById('ProductsExportToEbay').action =
                              '<@ofbizUrl>exportProductListing</@ofbizUrl>?isProductId=${content.product.productId!}';document.getElementById('ProductsExportToEbay').submit();">${content.product.productName!}
                          [${content.product.productId}]
                          </a>
                        </li>
                      <#else>
                        <li <#if isProductId?? && isProductId! == content.product.productId! >class="selected"
                            <#assign isProductId = content.product.productId!><#else>id="tabHeader${id}"</#if>>
                          <a href="javascript:document.getElementById('ProductsExportToEbay').action =
                              '<@ofbizUrl>exportProductListing</@ofbizUrl>?isProductId=${content.product.productId!}';document.getElementById('ProductsExportToEbay').submit();">${content.product.productName!}
                            [${content.product.productId}]
                  ...
                  <#if isProductId == item.getSKU()!>
                    ...
                    <table cellspacing="0" width="70%">
                      <tr>
                        ...
                        <td>
                          <div>
                            <input type="text" readonly="readonly" name="itemFee"
                                value="${request.getAttribute("itemFee")!}"/>
                            <!-- itemlisting buttons bar -->
                            <a href="#"
                                onclick="javascript:document.ProductsExportToEbay.action=
                                '<@ofbizUrl>updateProductExportDetail</@ofbizUrl>';document.ProductsExportToEbay.submit();"
                                class="buttontext">
                            ...
                            <#if isSaved?? && isSaved=="Y">
                              <a href="#" class="buttontext"
                                  onclick="javascript:document.ProductsExportToEbay.action='<@ofbizUrl>verifyItemBeforeAddAndExportToEbay</@ofbizUrl>';document.ProductsExportToEbay.submit();">
                                Verifly Item
                              </a>
                            </#if>
                            <a href="#" class="buttontext"
                                onclick="javascript:document.ProductsExportToEbay.action='<@ofbizUrl>removeProductFromListing</@ofbizUrl>';document.ProductsExportToEbay.submit();">
                              Remove
                            </a>
                          ...
                          <tr>
                              ...
                              <table cellspacing="0">
                                <tr>
                                  ...
                                  <td>
                                    ...
                                    <input type="text" readonly="readonly" name="site"
                                        value="${item.getSite().name()!} [${item.getSite()!}]"/>
                                  </td>
                                </tr>
                                <!-- set ebay category -->
                                <tr>
                                  ...
                                  <td>
                                    <div>
                                      <div id="loading"></div>
                                      <select id="ebayCategory" name="ebayCategory"
                                          onchange="retrieveEbayCategoryByParent('<@ofbizUrl>retrieveEbayCategoryByParent</@ofbizUrl>',this.value,'${productStoreId}','ebayCategory')">
                                        ...
                                        <#if categories??>
                                          <#if primaryCate?has_content>
                                            ...
                                            <option selected="selected"
                                                    value="${primaryCate.getCategoryID()!}:${leafCate!}">${primaryCate.getCategoryName()!}</option>
                                          <#else>
                                            <#list categories as csCate>
                                              ...
                                              <option
                                                  value="${csCate.getCategoryID()!}:${leafCate!}">${csCate.getCategoryName()!}</option>
                                            </#list>
                                          </#if>
                                        </#if>
                                      </select>
                                      <a class="buttontext"
                                          href="javascript:retrieveEbayCategoryByParent('<@ofbizUrl>retrieveEbayCategoryByParent</@ofbizUrl>','CH_<#if primaryCate?has_content>${primaryCate.getCategoryID()!}</#if>','${productStoreId}','ebayCategory')">${uiLabelMap.EbayChangeCategory}</a>
                                      <a class="buttontext"
                                          href="javascript:document.getElementById('ProductsExportToEbay').action = '<@ofbizUrl>setSelectedCategory</@ofbizUrl>?isProductId=${isProductId!}';document.getElementById('ProductsExportToEbay').submit();">${uiLabelMap.EbaySet}</a>
                                    </div>
                                  ...
                                  <td>
                                    <div>
                                      ...
                                      <select id="ebayStore1Category" name="ebayStore1Category"
                                          onchange="retrieveEbayCategoryByParent('<@ofbizUrl>retrieveEbayStoreCategoryByParent</@ofbizUrl>',this.value,'${productStoreId}','ebayStore1Category')">
                                        <option value="">Please select</option>
                                        <option value="">------</option>
                                        <#if storeCategories??>
                                          <#if storeFront?has_content>
                                            ...
                                            <option selected="selected"
                                                value="${storeFront.getStoreCategoryID()!}">
                                              ${storeFront.getStoreCategoryID()!}
                                            </option>
                                          <#else>
                                  ...
                                  <td>
                                    <div>
                                      ...
                                      <select id="ebayStore2Category" name="ebayStore2Category"
                                          onchange="retrieveEbayCategoryByParent('<@ofbizUrl>retrieveEbayStoreCategoryByParent</@ofbizUrl>',this.value,'${productStoreId}','ebayStore2Category')">
                                        <option value="">Please select</option>
                                        <#if storeCategories??>
                                          <#if storeFront?has_content>
                                            <#--if !storeFront.isLeafCategory()?has_content>
                                            ...
                                            <option selected="selected"
                                                value="${storeFront.getStoreCategory2ID()!}">${storeFront.getStoreCategory2ID()!}</option>
                                          <#else>
                                            <#list storeCategories as csCate>
                                              <#--if !csCate.IsLeafCategory?has_content>
                                                  <#assign  leafCate  = "false">
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <input type="text" size="60" name="title" value="${item.getTitle()!}"/>
                                  </td>
                                </tr>
                                <tr>
                                  <td class="label">SKU</td>
                                  <td>
                                    <input type="text" readonly="readonly" name="sku" value="${item.getSKU()!}"/>
                                  </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <input type="text" readonly="readonly" name="country" size="20"
                                        value="${countryname!?default(item.getCountry().value()!)}"/>
                                  </td>
                                </tr>
                                <tr>
                            ...
                            <td width="40%" valign="top">
                              <table width="100%" height="100%" id="table2" cellspacing="0">
                                <tr>
                                  <td>
                                    <img src="<@ofbizContentUrl>${contentPathPrefix!}${smallImageUrl}</@ofbizContentUrl>"
                                        alt="Small Image"/><br/>
                                ...
                                <table align="left" width="60%" height="100%" cellspacing="0">
                                    ...
                                    <td>
                                      <label>
                                        <input type="checkbox" value="Y"
                                            onclick="javascript:enabledItemTemplate(this.value);" id="enabledTheme"
                                            name="enabledTheme"/>
                                        <b>Add a theme</b>
                                      </label>
                                    </td>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <#if adItemTemplates?has_content>
                                        <select id="themeGroup" disabled
                                            onchange="javascript:retrieveTemplateByTemGroupId(this.value,'${productStoreId!}','${primaryCate.getCategoryID()!}');"
                                            name="themeGroup">
                                          <#list adItemTemplates as adItemTemplate>
                                            <option value="${adItemTemplate.TemplateGroupId!}">
                                              ${adItemTemplate.TemplateGroupName!}
                                            </option>
                                          </#list>
                                        </select>
                                      </#if>
                                  ...
                                  <tr>
                                    ...
                                    <td valign="top">
                                      ...
                                      <a id="themeImgUrl" href="javascript:popUpImg();">
                                        <img hspace="5" height="120" border="0" align="top" width="100" id="themeImg"
                                            name="themeImg"
                                            src="http://pics.ebay.com/aw/pics/vit/None2_sample_100x120.gif" alt=""/>
                                      </a>
                                      <br/>
                              ...
                              <#-- default with aution and fixed price -->
                                <#if listingType.type.equals("Chinese") || "FixedPriceItem" == listingType.type>
                                  ...
                                  <li <#if id==1 > style="margin-left: 1px" id="tabHeaderActive_"<#else>
                                      id="tabHeader_${id}" </#if>>
                                    <a href="javascript:void(0)" onclick="toggleTab(${id},2)">
                                      <span>${tabName!}</span>
                                    </a>
                                  </li>
                                  <#assign id = id + 1>
                                  ...
                                  <table width="50%" height="100%" id="table2" cellspacing="0">
                                    <tr>
                                      ...
                                      <td>
                                        <#if listingType.type.equals("Chinese")>
                                          <label>
                                            <input type="radio" name="listype" value="auction"/>
                                            <b>${tabName!}</b>
                                          </label>
                                        ...
                                        <#elseif "FixedPriceItem" == listingType.type>
                                          ...
                                          <#--input type="checkbox" value="Y" name="enabledFixedPrice_${id}" />
                                            <b>${tabName!}</b></checkbox-->
                                        </#if>
                                      </td>
                                    ...
                                    <tr>
                                      ...
                                      <td>
                                        <#if listingType.type.equals("FixedPriceItem") >
                                          <input type="text" size="3" value="1" name="quantity_${id}"
                                              size="12" maxlength="3"/>
                                        <#else>
                                          <input type="text" size="3" value="1" disabled name="quantity_${id}" size="12"
                                              maxlength="3"/>
                                        </#if>
                                      </td>
                                    ...
                                    <tr>
                                      ...
                                      <#if listingType.type.equals("FixedPriceItem") >
                                        ...
                                        <td>
                                          <input type="text" size="6" name="startPrice_${id}" value="${min!}"/>
                                          ${currencyUomId!}
                                        </td>
                                        <td class="label"></td>
                                        <td></td>
                                      <#else>
                                        <td class="label">Start Price</td>
                                        <td><input type="text" size="6" name="startPrice_${id}" value="${min!}"/>
                                          ${currencyUomId!}
                                        </td>
                                        <td class="label">BIN Price</td>
                                        <td>
                                          <input type="text" size="6" name="buyItNowPrice_${id}" value="${max!}"
                                              <#if listingType.type.equals("FixedPriceItem")>disabled="disabled"</#if>/>
                                            ${currencyUomId!}
                                        </td>
                                      </#if>
                                    </tr>
                                    <#if !listingType.type.equals("FixedPriceItem") >
                                      <tr>
                                        ...
                                        <td>
                                          <input type="text" size="6" name="reservePrice_${id}"
                                              <#if listingType.type.equals("FixedPriceItem") >disabled="disabled"</#if>/>
                                          ${currencyUomId!}
                                        </td>
                                        <td class="label"></td>
                                    ...
                                    <#if listingType.type.equals("FixedPriceItem") >
                                      <tr>
                                        ...
                                        <td>
                                          <label>
                                            <input type="checkbox" value="true" name="enableBestOffer_${id}"/>
                                            <b>Enable Best Offer</b>
                                          </label>
                                        </td>
                                        <td class="label"></td>
                                        <td><br/></td>
                          ...
                          <table width="50%" height="100%" id="table2" cellspacing="0">
                            ...
                            <tr>
                              <td colspan="4">
                                ...
                                <#if paymentMethods?has_content>
                                  ...
                                  <#--assign i = 0>
                                  <#list paymentMethods as paymentMethod>
                                    <input type="checkbox" value="${paymentMethod.name()!}"
                                        name="${paymentMethod.name()!}_${id}">
                                      ${paymentMethod.value()!}</checkbox>
                                      <span style="width:40px"/><#if i==3><br />
                                      <#assign i = -1>
                                      </#if>
                                    <#assign i=i+1>
                                  </#list-->
                            ...
                            <#if is_payPal == true>
                              <tr>
                                ...
                                <td>
                                  <input type="text" name="paymentMethodPaypalEmail" id="paymentMethodPaypalEmail"
                                         size="50" maxlength="50" value="me@ebay.com"/>
                                </td>
                                <td class="label"></td>
                                <td><br/></td>
                              </tr>
                        ...
                        <div class="screenlet-body">
                          <table cellSpacing="0" cellPadding="0" width="100%" border="0">
                            <tr>
                              ...
                              <td>
                                <img height="1" src="http://pics.ebaystatic.com/aw/pics/tbx/s.gif" width="10" alt=""/>
                              </td>
                            </tr>
                            <tr>
                              <td></td>
                                ...
                                <#if shippingLocationDetails?has_content>
                                  <table>
                                    ...
                                    <#list shippingLocationDetails as shippingLocationDetail>
                                      ...
                                      <td valign="top">
                                        <label>
                                          <input type="checkbox" value="true" name="Shipping_${shippingLocation!}"/>
                                          <b>${shippingLocationDetail.getDescription()!}</b>
                                        </label>
                                      </td>
