...
// component ("assetmaint") only - a caller can never trigger or poll another component's tests
...
Map runAssetmaintTestSuite() {
    return TestRunServices.runScopedTestSuite(dctx, parameters, 'assetmaint')
}

Map getAssetmaintTestRunStatus() {
    return TestRunServices.getScopedTestRunStatus(dctx, parameters, 'assetmaint')
}
