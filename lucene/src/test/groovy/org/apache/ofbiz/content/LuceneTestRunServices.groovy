...
// component ("lucene") only - a caller can never trigger or poll another component's tests
...
Map runLuceneTestSuite() {
    return TestRunServices.runScopedTestSuite(dctx, parameters, 'lucene')
}

Map getLuceneTestRunStatus() {
    return TestRunServices.getScopedTestRunStatus(dctx, parameters, 'lucene')
}
