...
context.postalAddressInfos = postalAddressInfos
...
context.canNotView = !security.hasEntityPermission('PARTYMGR', '_VIEW', session)
        && (context.creditCard || context.giftCard || context.eftAccount)
        && context.paymentMethod
        && userLogin.partyId != context.paymentMethod.partyId
