...
// component ("scrum") only - a caller can never trigger or poll another component's tests
...
Map runScrumTestSuite() {
    return TestRunServices.runScopedTestSuite(dctx, parameters, 'scrum')
}

Map getScrumTestRunStatus() {
    return TestRunServices.getScopedTestRunStatus(dctx, parameters, 'scrum')
}
