...
// component ("example") only - a caller can never trigger or poll another component's tests
// through these two services, regardless of what componentName (if any) they supply.
//
// Meant to double as the copy-paste template for any other component adopting the same pattern:
// copy this script, rename it and its two methods, and change the 'example' literal below - no
